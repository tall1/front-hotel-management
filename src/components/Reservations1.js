...
export default function Reservations1() {
                ...
                <Table style={customTableStyle} aria-label="customized table">
                    <TableHead>
                        <TableRow>
                            ...
                            <StyledTableCell style={customColumnStyle} align="left">Guests Amount</StyledTableCell>
                    ...
                    <TableBody style={{width: 100}}>
                        {reservations.map((reservations) =>
                            (
                                <StyledTableRow key={reservations.reservationNumber}>
                                    <StyledTableCell component="th" scope="row" style={{textDecoration: 'none'}}>
                                        <Link className={'table-link'}
                                              to={`/reservations/${reservations.reservationNumber}`}>{reservations.reservationNumber}</Link>
                                    </StyledTableCell>
                                    <StyledTableCell align="left">{reservations.guestName}</StyledTableCell>
                                    <StyledTableCell align="left">{reservations.guestsAmount}</StyledTableCell>
                                    <StyledTableCell align="left">{reservations.checkin}</StyledTableCell>
                                    <StyledTableCell align="left">{reservations.checkout}</StyledTableCell>
                                </StyledTableRow>
                            )
                        )}
                    </TableBody>
